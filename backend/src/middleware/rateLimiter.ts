...
export const RATE_LIMIT_RULES: Array<{ prefix: string; rule: RateLimitRule }> = [
  ...
  { prefix: '/developers/application/submit', rule: { limit: 10, windowSeconds: 300 } },
  { prefix: '/developers/team', rule: { limit: 60, windowSeconds: 60 } },
  ...
  { prefix: '/developers/payouts', rule: { limit: 10, windowSeconds: 300 } },
  { prefix: '/community/discussions', rule: { limit: 20, windowSeconds: 60 } },
  { prefix: '/community/reports', rule: { limit: 10, windowSeconds: 60 } },
  { prefix: '/api/v1', rule: { limit: 120, windowSeconds: 60 } },
