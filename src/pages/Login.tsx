...
export default function Login() {
  ...
  const { user, isLoading: authLoading, login, register, forgotPassword, resetPassword } = useAuth();
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              onClick={() => toast('Social sign-in is not available yet — use your email or phone.', { icon: 'ℹ️' })}
