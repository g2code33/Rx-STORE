    ...
    <div className="section-container py-8 lg:py-12">
      ...
      {categoryApps.length > 0 ? (
        ...
        <div className="text-center py-20">
          <div className="text-5xl mb-4">📭</div>
          <h3 className="text-xl font-semibold text-white mb-2">No applications in this category yet</h3>
          <p className="text-rx-gray-medium">Check back soon for new additions.</p>
        </div>
      )}
    </div>
  );
